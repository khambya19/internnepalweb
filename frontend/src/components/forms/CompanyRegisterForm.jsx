// src/components/forms/CompanyRegisterForm.jsx
...
const CompanyRegisterForm = ({ onSuccess, switchToLogin }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col flex-1">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 pb-2 flex-1">
        <div className="mb-6">
          <div className="flex items-center bg-white border rounded-md px-3 py-2.5 transition-all focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 ${errors.companyName ? 'border-red-500 bg-red-50' : 'border-gray-300'}">
        ...
        <div className="mb-6">
          <div className="flex items-center bg-white border rounded-md px-3 py-2.5 transition-all focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 ${errors.website ? 'border-red-500 bg-red-50' : 'border-gray-300'}">
